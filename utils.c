/* $Id: utils.c,v 1.21 2001/03/18 18:55:06 astyanax Exp $ */
/**************************************************************************
 *   utils.c                                                              *
 *                                                                        *
...
char *strcasestr(char *haystack, char *needle)
{
    ...
    localneedle = (char *)nmalloc(strlen(needle) + 2);
    localhaystack = (char *)nmalloc(strlen(haystack) + 2);
...
void new_magicline(void)
{
    ...
    filebot->next->data = (char *)nmalloc(1);
